...
function* workerTestExercise(action) {
    try {
        ...
        yield put(testExerciseCompile(compilerAction.compiler, action.userSolution,
        ...
        yield put(testExerciseDeploy(compilationResultAction.code.contracts,
        ...
        yield put(testContracts(TEST_EXERCISE_CODE_ID,
            deploymentResultAction.validation,
            deploymentResultAction.exerciseAddresses));
